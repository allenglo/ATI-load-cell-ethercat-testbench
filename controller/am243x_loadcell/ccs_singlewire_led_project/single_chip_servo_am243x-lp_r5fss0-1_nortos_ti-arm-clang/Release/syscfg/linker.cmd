...
SECTIONS
{
    ...
    .gSddfChSampsRaw (NOLOAD) : {
    } > R5F_TCMB0_SDDF_0_1   , align(4) 
...
MEMORY
{
    ...
    R5F_TCMB0_SDDF_0_1   : ORIGIN = 0x78100080 , LENGTH = 0x80 
    R5F_TCMB0_ENC_0_1   : ORIGIN = 0x78100100 , LENGTH = 0x100 
    R5F_TCMB0_PDO   : ORIGIN = 0x41010200 , LENGTH = 0x100 
    R5F_TCMB0   : ORIGIN = 0x41010300 , LENGTH = 0x7D00 
    MSRAM_0_1   : ORIGIN = 0x70180000 , LENGTH = 0x3FE00 
